// Fallback estático das avaliações exibidas na home.
// Mantido em módulo separado para ser carregado sob intenção
// (quando a seção de avaliações entra perto da viewport),
// evitando impacto no HTML/JS inicial da home.
...
export const homeReviewsFallback: HomeReview[] = [
    {
        name: "Kleber do R.",
        rating: 5,
        date: "há 3 dias",
